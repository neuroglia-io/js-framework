...
export async function loadRemoteModule<T extends object = any>(options: LoadRemoteModuleOptions): Promise<T>;
export async function loadRemoteModule<T extends object = any>(remoteName: string, exposedModule: string): Promise<T>;
