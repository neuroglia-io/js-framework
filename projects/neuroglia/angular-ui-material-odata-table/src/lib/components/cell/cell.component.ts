...
@Component({
  selector: 'neuroglia-mat-odata-table-cell',
...
export class CellComponent implements OnChanges, OnDestroy {
  ...
  constructor(
    private odataTableTemplateProvider: ODataTableTemplateProvider,
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (
      ...
      const componentType = this.odataTableTemplateProvider.getCellTemplate(
        this.row,
      ...
      if (componentType) {
        ...
        this.cellRef.instance.odataTable = this.odataTable;
