...
export interface IMaterialQueryableTableStore<
  TState extends QueryableTableState<TData> = QueryableTableState<any>,
  TData = any,
> extends QueryableTableStore<TState, TData>,
    WithDialog {}

export function showFilterDialog<TState extends QueryableTableState<TData> = QueryableTableState<any>, TData = any>(
  this: IMaterialQueryableTableStore<TState, TData>,
  dialogType: Type<any>,
